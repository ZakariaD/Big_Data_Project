...
DROP DATABASE IF EXISTS big_data_project CASCADE; -- this will drop tables before dropping the database
...
LOAD DATA INPATH '/user/hdfs/BigDataProject/yearlyGasData/formattedYearlyData.xml' INTO table xmlgasdata;
