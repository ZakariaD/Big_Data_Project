...
listPrimaryType() 
{
	...
	awk '
		...
		{ 
				...
				else if("'"$arg_description"'" == "" && $18 == "'"$arg_year"'" && $9 == "'"$arg_arrested"'") { 
				...
				else if("'"$arg_description"'" == "" && $18 == "'"$arg_year"'" && "'"$arg_arrested"'" == "") { 
				...
				else if("'"$arg_description"'" == "" && "'"$arg_year"'" == "" && $9 == "'"$arg_arrested"'") { 
				...
				else if("'"$arg_description"'" == "" && "'"$arg_year"'" == "" && "'"$arg_arrested"'" == "") { 
